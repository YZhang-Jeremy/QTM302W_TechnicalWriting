...
```{R}
covid <- read.csv("./data/COVID-19_Daily_Counts_of_Cases__Hospitalizations__and_Deaths_20231116.csv")
...
```{R}
hate_crime <- read.csv("./data/NYPD_Hate_Crimes_20231116.csv")
...
```{R}
unemployment <- read.csv("./data/NYUR.csv")
